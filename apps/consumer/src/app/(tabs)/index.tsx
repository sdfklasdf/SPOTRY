...
const styles=StyleSheet.create({
  ...
  mark:{width:19,height:19,borderRadius:7,backgroundColor:colors.actionGreen,transform:[{rotate:'32deg'}]},
  ...
  heroEyebrow:{fontFamily:typography.family.sans,fontSize:11,fontWeight:'800',letterSpacing:1.2,color:colors.actionGreen},
  ...
  kicker:{fontFamily:typography.family.sans,fontSize:11,fontWeight:'800',letterSpacing:1.1,color:colors.actionGreen},
