...
const styles=StyleSheet.create({content:{padding:spacing[5],paddingBottom:spacing[8],gap:spacing[5],backgroundColor:colors.canvas},hero:{height:250,borderRadius:radius.xl,overflow:'hidden',position:'relative',backgroundColor:colors.ink[950]},heroImage:{position:'absolute',width:'100%',height:'100%'},scrim:{position:'absolute',left:0,right:0,top:0,bottom:0,backgroundColor:'rgba(11,17,27,.36)'},heroCopy:{position:'absolute',left:spacing[5],right:spacing[5],bottom:spacing[5],gap:spacing[2]},eyebrow:{fontFamily:typography.family.sans,fontSize:11,fontWeight:'800',letterSpacing:1.1,color:colors.action[500]},heroTitle:{fontFamily:typography.family.sans,fontSize:typography.size.xxl,lineHeight:typography.lineHeight.xxl,fontWeight:typography.weight.bold,color:colors.canvas},heading:{gap:spacing[1]},title:{fontFamily:typography.family.sans,fontSize:typography.size.xxl,lineHeight:typography.lineHeight.xxl,fontWeight:typography.weight.bold,color:colors.ink[950]},caption:{fontFamily:typography.family.sans,fontSize:typography.size.sm,lineHeight:typography.lineHeight.sm,color:colors.ink[600]},chips:{gap:spacing[2],paddingRight:spacing[5]},results:{gap:spacing[3]},truth:{fontFamily:typography.family.sans,fontSize:typography.size.xs,lineHeight:typography.lineHeight.xs,color:colors.ink[400]}});
